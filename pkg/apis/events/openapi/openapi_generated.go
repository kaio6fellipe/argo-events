		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"projectKey": {
						SchemaProps: spec.SchemaProps{
							Description: "DeprecatedProjectKey is the key of the project to which the repository relates\n\nDeprecated: use Repositories instead. Will be unsupported in v1.9",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"repositorySlug": {
						SchemaProps: spec.SchemaProps{
							Description: "DeprecatedRepositorySlug is a URL-friendly version of a repository name, automatically generated by Bitbucket for use in the URL\n\nDeprecated: use Repositories instead. Will be unsupported in v1.9",
							Type:        []string{"string"},
							Format:      "",
						},
					},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"projectKey": {
						SchemaProps: spec.SchemaProps{
							Description: "DeprecatedProjectKey is the key of project for which integration needs to set up.\n\nDeprecated: use Repositories instead. Will be unsupported in v1.8.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"repositorySlug": {
						SchemaProps: spec.SchemaProps{
							Description: "DeprecatedRepositorySlug is the slug of the repository for which integration needs to set up.\n\nDeprecated: use Repositories instead. Will be unsupported in v1.8.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"repository": {
						SchemaProps: spec.SchemaProps{
							Description: "DeprecatedRepository refers to GitHub repo name i.e. argo-events\n\nDeprecated: use Repositories instead. Will be unsupported in v 1.6",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"projectID": {
						SchemaProps: spec.SchemaProps{
							Description: "DeprecatedProjectID is the id of project for which integration needs to setup\n\nDeprecated: use Projects instead. Will be unsupported in v 1.7",
							Type:        []string{"string"},
							Format:      "",
						},
					},
